					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Branch Add New</strong>
							</div>
							<div class="card-body card-block">
								<form action="BranchMasterServlet" method="post" class="form-horizontal">
									...
									<div class="row form-group">
										...
										<div class="col col-md-5">
											<input type="text" id="text-input" name="BranchLocation"
												placeholder="enter branch name" class="form-control" required="required"
												id="inputID">
										</div>
